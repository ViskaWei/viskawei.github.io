...
export const projectNodes: ProjectNode[] = [
  // ── Projects ──────────────────────────────────────────────
  {
    ...
    year: 2020, semester: 'Spring', track: 'physics',
    nodeType: 'project',
  },
  {
    id: 'proj-cancer', name: 'Cancer Clustering',
    relatedCourses: ['EN553636'],
    year: 2022, semester: 'Spring', track: 'ml',
    nodeType: 'project',
  },
  {
  ...
  {
    id: 'pub-cancer', name: 'IEEE BigData: Cancer Subtype',
    relatedCourses: ['EN553636'],
    year: 2020, semester: 'Fall', track: 'ml',
    nodeType: 'publication', venue: 'IEEE Big Data',
  },
  {
    id: 'pub-cocoon', name: 'COCOON: Sketch and Scale',
